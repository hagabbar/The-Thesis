...
\hunter{Hey Chris. This chapter is in flux because we are still editing this 
paper. Also, some figures and tables are not properly formatted. You can review 
sections \ref{sec:add_analy_vit}, \ref{sec:phipsi_repar}, 
\ref{sec:vit_data_aug}.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Training procedure}\label{app:training_procedure}
%
...
%
% Discuss Dyn vs. Dyn for 1D JS histogram plot
%

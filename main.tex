...
\documentclass[12pt,titlepage,oneside,nofootinbib,aps,prl,reprint,floatfix,showpacs]{book}
...
%  linkbordercolor=black,  % border color of links
...
\acrodef{VC}[VC]{Vapnik-Chervonenkis}
...
\acrodef{IMR}[IMR]{insprial-merger-ringdown}
\acrodef{Phenom}[Phenom]{Phenomenological}
...
\acrodef{MH}[MH]{Metropolis-Hastings}
...
\acrodef{AI}[AI]{aritificial intelligence}
\acrodef{CMB}[CMB]{cosmic microwave background}
\acrodef{NESSAI}[\texttt{NESSAI}]{Nested Sampling with Artificial Intelligence}
...
\include{GW_background}
\include{ML_background}
\include{GW_ML_Overview}
\include{matching_matched_filtering}
%\include{technical_matching}
\include{vitamin}
%\include{technical_vitamin}
\include{conclusions}

%\include{ThesisOutline}
